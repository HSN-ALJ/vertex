window.addEventListener("load", function () {
	...
	window.addEventListener("message", function (evt) { //lua actions
		...
		// REQUEST
			...
			var audio = new Audio('https://cdn.discordapp.com/attachments/921903126129299507/934634276497006622/zapsplat_multimedia_game_sound_double_short_generic_click_pop_006_38515.mp3');
			audio.volume = 0.1;
			audio.play();
		...
		// CONTROLS
			...
			if (data.event == "UP") {
				var audio = new Audio('https://cdn.discordapp.com/attachments/1256985832674295970/1272378231202512926/up.wav?ex=66bcbc51&is=66bb6ad1&hm=154fda4b0be36be61b9112dd1c85ab099fca0c22d243f0d4baf49f7062a5cf39&');
				audio.volume = 0.2;
				audio.play();

			}
			else if (data.event == "DOWN") {
				var audio = new Audio('https://cdn.discordapp.com/attachments/1256985832674295970/1272378219412197417/down.wav?ex=66bcbc4f&is=66bb6acf&hm=24c453515342526472ec0561649bb41ab33c018a3f4dc2660e7e3d18601942e6&');
				audio.volume = 0.2;
				audio.play();
				/*if (!wprompt.opened)
